...
class DDList(Frame):
    def __init__(self, master, item_width, item_height, item_relief=None, item_background=None, item_borderwidth=None,
                 offset_x=0, offset_y=0, gap=0, **kwargs):
    ...
    def create_item(self, value=None, **kwargs):
        ...
        item = Item(self.master, value, self._item_width, self._item_height, self._on_item_selected,
                    self._on_item_dragged, self._on_item_dropped, **kwargs)
        return item
    ...
    def _on_item_dropped(self):
        ...
        for i in range(min(self._index_of_selected_item, self._index_of_empty_container),
