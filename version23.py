...
class Table(object):
    ...
    def add_data(self):
        ...
        last_sensor = list(mycol.find({}, {'_id': 0, 'Sensor No': -1}).sort("Sensor No", -1).limit(1))
        last_sensor_no = last_sensor[0].get('Sensor No')
        print("LAST SENSOR NO", last_sensor_no)

        # if sensor_name == last_sensor_no:
        ...
        global primary_key
        self.primary_key = primary_number + 1
